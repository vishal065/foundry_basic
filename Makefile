...
# # signup to https://etherscan.io/register for ETHERSCAN_API_KEY
# deploy-sepolia:
# 	forge script script/DeployFundMe-v2.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
-include .env
